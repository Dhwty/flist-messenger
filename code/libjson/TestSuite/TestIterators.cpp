...
void TestSuite::TestIterators(void){
    ...
    UnitTest::SetPrefix("Iterator");
		  ...
		  UnitTest::SetPrefix("Iterator Find");
		  json_delete(test);
		  ...
		  assertAutoCString(json_as_string(*ti), JSON_TEXT("World"));
			 ...
			 assertAutoCString(json_as_string(*ti), JSON_TEXT("World"));
		  #endif
		  UnitTest::SetPrefix("Iterator Erase");
		  ...
		  assertEquals(ti, json_end(test));
				...
				assertNull(((JSONNode*)test) -> internal -> Children.array);
			 #endif
		  #endif
		  ...
		  UnitTest::SetPrefix("Iterator Bulk Erase");
		  CreateTest(test);
		  ...
		  UnitTest::SetPrefix("Iterator Insert");
		  CreateTest(test);
		  ...
		  UnitTest::SetPrefix("Iterator Bulk Insert");
		  ...
		  UnitTest::SetPrefix("Const Iterator");
		  ...
		  UnitTest::SetPrefix("Reverse Iterator");
		  assertEquals(test.size(), 3);
		  ...
		  UnitTest::SetPrefix("Reverse Const Iterator");
		  assertEquals(test2.size(), 3);
		  ...
		  #ifdef JSON_UNIT_TEST
			 #ifdef JSON_LESS_MEMORY
				assertNull(test.internal -> Children.array);
			 #endif
		  #endif
		  ...
		  UnitTest::SetPrefix("Iterator Bulk Reverse Erase");
		  CreateTest(test);
