...
namespace FHttpApi {
    ...
    class Endpoint {
        public:
             ...
             * */
            virtual Request<TicketResponse> *getTicket(crQString username, crQString password, DataTypes additionalInfo = Data_GetTicketDefault) = 0;
            QByteArray encodePostData(QHash<QString, QString> params);
